    ...
    // you can use request.url, request.type and request.postData here
      ...
      if (requestUrlComponents.length >= 3) {
        ...
        this.logTracker.getSessionDetails(sessionId).then(sessionData => {
          ...
          httpBridge.respond(request.requestId, 200, 'text/html', responseHtml);
        });
      } else {
            ...
            for (let index = 0; index < allKeys.length; index++) {
              ...
              this.logTracker
                ...
                .then(currentSessionData => {
                  ...
                  const isBug = this.logTracker.getBugStatusBySessionId(key);
                ...
                `);
                  ...
                  if (index === allKeys.length - 1) {
                    const responseHtml = this.replace(sessionDash, {
                      session_data: sessionData.reverse().join(''),
